...
public interface UserDisplayAllMapper {
    ...
    @Mapping(source = "systemRole", target = "systemRole", qualifiedByName = "systemRoleToString")
    UserDisplayAllDTO toDTO(User user);
    ...
    @Named("systemRoleToString")
    static String systemRoleToString(SystemRole systemRole) {
